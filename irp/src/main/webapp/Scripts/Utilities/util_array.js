...
(function(Util) {
	...
	// The isArray() method returns true if an object is an array, false if it
	// is not.
	...
	// The concat() method returns a new array comprised of this array joined
	...
	A.slice = function(arr, start, opt_end) {
		...
		// passing 1 arg to slice is not the same as passing 2 where the second
		// is
		// null or undefined (in that case the second argument is treated as 0).
		// we could use slice on the arguments object and then use apply instead
		// of
		// testing the length
	 ...
	 * @param {number=}
	 *            opt_i The index at which to insert the object. If omitted,
	 *            treated as 0. A negative index is counted from the end of the
	 *            array.
	 */
	 ...
	 * supplied function returns `true`, and one with the items for which the
	 * function returns `false`.
	 * 
	 * @method partition
	 * @param {Array}
	 *            a Array to iterate over.
	 * @param {Function}
	 *            f Function to execute for each item in the array. It will
	 *            receive the following arguments:
	 * @param {Any}
	 *            f.item Current item.
	 * @param {Number}
	 *            f.index Index of the current item.
	 * @param {Array}
	 *            f.array The array being iterated.
	 * @param {Object}
	 *            [o] Optional execution context.
	 * @return {Object} An object with two properties: `matches` and `rejects`.
	 *         Each is an array containing the items that were selected or
	 *         rejected by the test function (or an empty array if none).
	 * @static
	 */
	A.partition = function(a, f, o) {
		...
		A.each(a, function(item, index) {
			var set = f.call(o, item, index, a) ? results.matches
					: results.rejects;
			set.push(item);
		});
	...
	/**
	 * Creates an array of arrays by pairing the corresponding elements of two
	 * arrays together into a new array.
	 * 
	 * @method zip
	 * @param {Array}
	 *            a Array to iterate over.
	 * @param {Array}
	 *            a2 Another array whose values will be paired with values of
	 *            the first array.
	 * @return {Array} An array of arrays formed by pairing each element of the
	 *         first array with an item in the second array having the
	 *         corresponding index.
	 * @static
	 */
	A.zip = function(a, a2) {
	 ...
	 * @static
	 * @param a
	 *            {Array} the array to find the subset of uniques for
	 * @param sort
	 *            {bool} flag to denote if the array is sorted or not. Defaults
	 *            to false, the more general operation
	...
	/**
	 * Flattens an array of nested arrays at any abitrary depth into a single,
	 * flat array.
	 * 
	 * @method flatten
	 * @param {Array}
	 *            a Array with nested arrays to flatten.
	 ...
	 * @return {number} A negative number, zero, or a positive number as the
	 ...
	 * specified, elements are compared using <code>UA.defaultCompare</code>,
	 * which compares the elements using the built in < and > operators. This
	 * will produce the expected behavior for homogeneous arrays of String(s)
	 * and Number(s), unlike the native sort, but will give unpredictable
	 * results for heterogenous lists of strings and numbers with different
	 * numbers of digits.
	 * 
	 ...
	 * @param {Function=}
	 *            opt_compareFn Optional comparison function by which the array
	 *            is to be ordered. Should take 2 arguments to compare, and
	 ...
	 * <code>goog.array.defaultCompare</code>, which compares the elements
	 * using the built in < and > operators. This will produce the expected
	 * behavior for homogeneous arrays of String(s) and Number(s).
	 * 
	 * Runtime: Same as <code>Array.prototype.sort</code>, plus an additional
	 * O(n) overhead of copying the array twice.
	 * 
	 * @param {Array.
	 *            <T>} arr The array to be sorted.
	 * @param {?function(T,
	 *            T): number=} opt_compareFn Optional comparison function by
	 *            which the array is to be ordered. Should take 2 arguments to
	 *            compare, and return a negative number, zero, or a positive
	 *            number depending on whether the first argument is less than,
	...
	A.stableSort = function(arr, opt_compareFn) {
		...
		function stableCompareFn(obj1, obj2) {
			return valueCompareFn(obj1.value, obj2.value)
