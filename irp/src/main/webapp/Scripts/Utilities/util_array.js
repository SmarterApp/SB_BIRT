...
(function(Util) {
   ...
   * @param {number=}
   *          opt_i The index at which to insert the object. If omitted, treated
   ...
   * @param {Function}
   *          f Function to execute for each item in the array. It will receive
   ...
   *          a Array to iterate over.
   * @param {Array}
   *          a2 Another array whose values will be paired with values of the
   *          first array.
   ...
   * @param sort
   *          {bool} flag to denote if the array is sorted or not. Defaults to
   *          false, the more general operation
   ...
   * which compares the elements using the built in < and > operators. This will
   * produce the expected behavior for homogeneous arrays of String(s) and
   * Number(s), unlike the native sort, but will give unpredictable results for
   * heterogenous lists of strings and numbers with different numbers of digits.
   * 
   ...
   * @param {Function=}
   *          opt_compareFn Optional comparison function by which the array is
   *          to be ordered. Should take 2 arguments to compare, and return a
   *          negative number, zero, or a positive number depending on whether
   ...
   * @param {?function(T,
   *          T): number=} opt_compareFn Optional comparison function by which
   *          the array is to be ordered. Should take 2 arguments to compare,
   *          and return a negative number, zero, or a positive number depending
