...
Util.String.contains = function(str, search) {
  return (str && search && str.indexOf(search) !== -1);
};

// check if this string has an http url
Util.String.isHttpProtocol = function(str) {
  return (Util.String.startsWith(str, 'http:') || Util.String.startsWith(str,
      'https:'));
};

// C# style string formatter
// TODO: Review this
// https://github.com/prettycode/String.prototype.format.js/blob/master/String.prototype.format.js
...
// Indicates whether the specific string is null, empty, or consists only of
...
Util.HashCombiner.prototype.get = function() {
  return this._hash;
};
