...
Summit.SecureBrowser.Mobile = function () {
    ...
    AIRMobile.recorder = {
         ...
         *  @constant */
            ...
            // command to request the status of microphone access permission ("granted" or "denied")
             ...
             *  <li>EVENT_ERROR</li>
             *  @return {Boolean} indicate whether the command has been sent to the device
             */
            ...
            {
                AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_START, document, _eventListener, true);
                AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_END, document, _eventListener, true);
                ...
                AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_STOPPED, document, _eventListener, true);
                AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_ERROR, document, _eventListener, true);
            ...
            errorMessageForOptions: function(_options) {
                    ...
                    if (this.isValidDevice(deviceID)) {
                            ...
                            } else if (!this.isValidOption(device.formats, (_options.encodingFormat || '').toLowerCase())) {
            ...
            checkPermissionStatus: function (callback) {
                ...
                if (callback != null) {
                    ...
                    AIRMobile.callbacks[identifier] = function (response) {
                        // if the platform doesn't support this command, we have to assume
                ...
                AIRMobile.sendToApp(this.CMD_CHECK_PERMISSION_STATUS, JSON.stringify(params, null, true));
            }
    };
