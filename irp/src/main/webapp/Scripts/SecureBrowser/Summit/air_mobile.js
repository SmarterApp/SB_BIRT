...
Summit.SecureBrowser.Mobile = function() {
   ...
   * Javascript interface, it will respond by collecting the device information
   * and passing it back via the <code>AIRMobile.ntvOnDeviceReady()</code>
   * function.<br>
   * <br>
   * 
   ...
   * particular request, the response parameter of the callback will contain an
   * errorMessage, otherwise the device property of AIRMobile will have been
   * updated accordingly and can be inspected.
   * <hr>
   * <br>
   */
  var AIRMobile = {
    ...
    /**
     * (Internal)Command to request that the device report the status of speach
     * playback
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when the native application changes the
     * default url that is loaded on startup.
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when the native application is entering
     * the backgrounded.
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when the native application returns from
     * being backgrounded.
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when guided access is enabled/disabled
     * on the device.
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when a change in running processes is
     * detected.
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when TTS synchronization event has been
     * fired by the browser (iOS 7+ only).
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when the device keyboard has changed. At
     * the time this even is fired, the device.keyboard property will have been
     * updated to reflect the new keyboard.
     * 
     * @constant
     */
     ...
     * changed. At the time this event is fired, the device.micMuted property
     * will have been updated to reflect the new status. Currently Android only.
     * 
     * @constant
     */
    ...
    /**
     * Event dispatched by the document when the application has detected a
     * change in the contents of the clipboard. When the event is dispatched,
     * the contets of the clipboard, if available, are supplied via the events
     * data property.
     * 
     * @constant
     */
     ...
     *            Additionally, some properties may only apply to one type of
     *            software, iPhone OS devices, and Android devices, when this
     *            occurs, it is indicated in the properties documentation.
     */
    device : {
      ...
      /**
       * The AIRMobile version that the native application was built against. A
       * negative value indicates the field is uninitialized or unknown.
       * 
       * @type Number
       */
      apiVersion : -1.0,
       ...
       * detected that the device has been jailbroken or rooted. Note that the
       * application may not be able to detect this under all circumstances. For
       * instance, on iOS the device may check for the presence of a directory
       * typically found on jailbroken devices. The absence of this directory
       * does not mean the device is not jailbroken, only that we have not
       * detected that it is jailbroken.
       * 
       * @type boolean
       */
      rootAccess : false,
      ...
      /**
       * The device model. A String representing the model of the hardware. eg.
       * iPad, iPhone
       * 
       * @type String
       */
      ...
      /**
       * The name of the operating system running on the device. eg. iphone OS
       * 
       * @type String
       */
       ...
       * enabled on the device. Otherwise, guided access is disabled. *Note: On
       * android devices, this property will always be false, as android devices
       * do not have a guided access mode.
       * 
       * @type Boolean
       */
      ...
      /**
       * Status of Text-To-Speech on the device. *Note this refers to the state
       * native accessibility framework for the device. On iOS, this corresponds
       * to the "VoiceOver" accessibility option. On android this corresponds to
       * the TalkBack accessibility setting.
       * 
       * @type Boolean
       */
      ...
      /**
       * Status of Text-To-Speech engine on the device. To receive notifications
       * on status change use EVENT_TTS_CHANGED. This property refers to the
       * capability the application has of speaking text passed via javascript.
       * If the device is capable of handling these requests, its state will be
       * either 'idle' or 'playing', otherwise, a status of 'unavailable' will
       * be reported. Possible values include:
       * <ul>
       * <li>'idle' - A TTS engine is available for use, and is not currently
       * playing audio</li>
       * <li>'playing' - A TTS engine is available for use, and is currently
       * playing audio</li>
      ...
      /**
       * The keyboard that users device is configured to use. This property is
       * currently unique to android as the user can swap out the keyboard. The
       * included keyboard, which the user is required to switch to currently
      ...
      /**
       * Check if the device can currently take screenshots. For iphone OS, this
       * returns true when guided access is disabled, false otherwise. On
       * android, this function always returns false, this is because the native
       * application blocks the standard mechanism for taking screenshots. Users
       * should also inspect the installed applications property for android
       * devices to ensure that the user does not have an application that
       * directly accesses the screenbuffer installed.
       * 
       * @return {Boolean} true if it has been detected that the device can
       *         currently take a sceenshot by standard means.
       */
       ...
       * <br>
       * *NOTE This does not indicate if the feature is enabled, only that we
       * expect the device to support it. The result is based off of the
       * operating system reported by the device, eg. iphone OS supports guided
       * access mode, Android does not.<br>
       * <br>
       * 
       ...
       * 
       * @returns {String} a string in the form "Device: 'device_name', OS:
       *          'os_name', Version: 'os_version', Jailbroken : 'yes_or_no',
       *          Resolution : {width, height}"
       */
      formattedDeviceInfo : function() {
        var isiOS = this.operatingSystem.toLowerCase() == "iphone os";

        return "Device: " + this.model + ", OS: " + this.operatingSystem
    ...
    /**
     * Request the status of guided access on the device (iOS only). Sends an
     * asynchronous request to the device.
     * 
     * @param {String}
     *          identifier a unique identifier or null to autogenerate one.
     * @param {function}
     *          callback The callback to invoke when the device responds. The
     *          function should take a single parameter object that will contain
     *          a {Boolean} property called 'enabled'. Additionally, the
     *          original identifier will be provided via an 'identifier'
     ...
     * 
     * @param {Boolean}
     *          a boolean variable whether to enable (true) or disable (false)
     *          guided access.
     * @param {String}
     *          identifier a unique identifier or null to autogenerate one.
     * @param {function}
    ...
    enableGuidedAccess : function(toEnable, _identifier, _callback) {
      ...
      this.sendToApp(this.CMD_ENABLE_GUIDED_ACCESS, JSON.stringify(params,
          null, true));
    },

    /**
     * Request that the device update its list of running processes. Sends an
     * asynchronous request to the device.
     * 
     * @param {String}
     *          identifier a unique identifier or null to autogenerate one.
     ...
     *          callback The callback to invoke when the device responds. The
     *          function should take a single parameter object that will contain
     *          an {Array} property called 'runningProcesses'. Additionally, the
     *          original identifier will be provided via an 'identifier'
     *          property of the parameter.
     * 
     * @return {String} the unique identifier for the request.
    ...
    /**
     * Request that the device update its status for Text-To-Speech. Sends an
     * asynchronous request to the device.
     * 
     * @param {String}
     *          identifier a unique identifier or null to autogenerate one.
     ...
     *          callback The callback to invoke when the device responds. The
     *          function should take a single parameter object that will contain
     *          a {Boolean} property called 'enabled', and a {String} property
     *          called ttsEngineStatus. The important distinction between these
     *          two is that the former corresponds to the platforms native
     *          accessibility framework. When enabled, the device will
     *          automatically provide voice feedback to the users interactions.
     *          The ttsEngineStatus corresponds to the applications speech
     *          synthesis engine, which is controllable via these apis.
     *          Additionally, the original identifier will be provided via an
     *          'identifier' property of the parameter.
     * @return {String} the unique identifier for the request.
     */
    ...
    /**
     * Request to check the devices current orientation. Sends an asynchronous
     ...
     *          callback The callback to invoke when the device responds. The
     *          function should take a single parameter object that will contain
     *          a {String} property called 'orientation'. Additionally, the
     *          original identifier will be provided via an 'identifier'
     *          property of the parameter.
     * @return {String} the unique identifier for the request.
     */
     ...
     * necessarily change the orientation. For example, if the user is holding
     * the device in landscape, and a request is made to lock the device in
     * portait, the lock may not actually take effect until the device has been
     * rotated to portait. <br>
     * Eg.<br>
     ...
     * @param {function}
     *          callback The callback to invoke when the device responds. The
     *          function should take a single parameter object that will have
    ...
    requestOrientationLock : function(_orientation, _identifier, _callback) {
      ...
      this.sendToApp(this.CMD_LOCK_ORIENTATION, JSON.stringify(params, null,
          true));
     ...
     *  </code>
     * @param clipLength
     *          The length of the audio clip to record (in seconds). Neither
     *          AIRMobile, or the native devices will limit the duration of the
     *          clip, however, it is recommended to use a reasonably short
     *          length such as < ~30 seconds since the audio data is also
     *          transfered via javascript.<br>
     * @param identifier
     *          The unique identifier for the request.
     * @param {function}
     *          callback The callback to invoke when complete. <br>
     *          The function should take a single parameter, an object which
    ...
    setDefaultURL : function(_urlString, _identifier, _callback) {
      ...
      this.sendToApp(this.CMD_SET_DEFAULT_URL, JSON.stringify(params, null,
          true));
     ...
     * callback will be invoked in the case that the device does not support the
     * command.
     * 
     * @return {String} the unique identifier for the request.
     */
    exitApplication : function(_identifier, _callback) {
      return this
          .sendCommand(this.CMD_EXIT_APPLICATION, _identifier, _callback);
    },
    ...
    /**
     * Request that the device mute the microphone. Upon completion, the device
     * property will reflect the new state of the mic. **This method is for
     * Android only**
     * 
     * @param {Boolean}
    ...
    /**
     * Called in response to a request that is not supported by the device. When
     * received, the original callback is executed using a response object
    ...
    /**
     * Called when The native TextToSpeech engine is enabled on the device, or
     * in response to a request to check the status of TextToSpeech.
     * 
     * @param Parameters
     *          JSON representation of the result
    ...
    /**
     * Called when the application detects a 'Samsung' mini app running on the
     * device.
     * 
     * @return {String} 'OK'
     */
    ...
    /**
     * Called when the application has detected the contents of the clipboard
     * have changed.
     * 
     * @param {String}
     *          Parameters JSON representation of the result.
    ...
    dispatchMessageEvent : function(_eventName, _message) {
      ...
      if (_eventName && _eventName.length > 0) {
        ...
        event.initMessageEvent(_eventName, true, true, _message, origin, 12,
            window, null);
        document.dispatchEvent(event);
        result = true;
      }
     ...
     * should use <code>console.log()</code> or one of its varients, rather
     * than this to log to the device.
     * 
     * @param {object}
     *          parameters
    ...
    /**
     * Send a message to a native ios app via its url loading mechanism. The url
     * that's loaded takes the form key:##airMobile_msgsnd##value, where key and
     * value are parsed out of the url in the application. <br>
     * <br>
     * Note* this mechanism will only work with the native counterpart of
     * <code>AIRMobile</code>.
     * 
     * In our context, the <code>key</code> passed should be one of a known
     * set of commands that the native application understands. Additionally,
     * the <code>value</code> parameter should be in a format that the
     * application expects and can understand. When applicable, the
     * <code>value</code> parameter will typically be a JSON string with
     * additional info about what the command should do.
     * 
     * @param {String}
    ...
    /**
     * Utility function to generate a unique identifier. Users can call this to
     * generate an identifier for request methods.
     * 
    ...
    /**
     * Convenience function to add a listener to an event. Supports W3C and IE
     * event mechanisms.
     * 
     * @param {String}
     ...
     * function is automatically invoked when the window's load event is fired.
     * It is unneccessary to call this manually.<br>
     * <br>
     ...
     * device info will be set up, and the
    ...
    security : {
      ...
      /**
       * Checks that all relevant security measures are enabled and returns a
       * boolean to confirm
       */
      ...
      /**
       * This function is a placeholder and does not perform any actions. It's
       * presence is only to comply with AIR certification. Since most simply
       * opening the application, this function is not necessary or possible.
       */
       ...
       * 
       * @param {boolean}
       *          _restart application will restart after closing if true
       */
      ...
      /**
       * Retrieve device details. This method is called to retrieve detailed
       * information about a device. The returned data includes teh manufacturer
       * name, device model number (with hardware revision number if available),
       * and OS version (major, minor, and build number). The format of this
       * string is '<key>=<value>' pairs seperated by the '|' symbol. The
       * valid keys are 'Manufacturer', 'HWVer', and 'SWVer'.
       */
    ...
    tts : {
      ...
      /**
       * Request that the device speak a string of text. Before calling this
       * function, you should first check to ensure that the device can
       * synthesize text by using the AIRMobile.tts.getStatus function. Upon
       * receiving the message on device, the callback will be invoked
       * reflecting the state of the engine (eg. 'playing'). When the device
       * completes playback, an additional event will be fired
       * (EVENT_TTS_CHANGED) and the device.ttsEngineStatus will be updated
       * accordingly.
       * 
       * @param {String}
      ...
      speak : function(_textToSpeak, _options, _callback) {
        ...
        if (AIRMobile.device.operatingSystem.toLowerCase() == "iphone os") {
          AIRMobile.sendToApp(AIRMobile.CMD_SPEAK_TEXT, encodeURIComponent(JSON
              .stringify(params, null, true)));
        } else {
          AIRMobile.sendToApp(AIRMobile.CMD_SPEAK_TEXT, JSON.stringify(params,
              null, true));
        }
      ...
      stop : function(_identifier, _callback) {
        return AIRMobile.sendCommand(AIRMobile.CMD_STOP_SPEAKING, _identifier,
            _callback);
      },
      ...
      setPitch : function(pitch) {
        ...
        AIRMobile.sendToApp(AIRMobile.CMD_TTS_SETPITCH, JSON.stringify(params,
            null, true));
      },
      ...
      setRate : function(rate) {
        ...
        AIRMobile.sendToApp(AIRMobile.CMD_TTS_SETRATE, JSON.stringify(params,
            null, true));
      },
      ...
      setVolume : function(volume) {
        ...
        AIRMobile.sendToApp(AIRMobile.CMD_TTS_SETVOLUME, JSON.stringify(params,
            null, true));
      }
    },
  };
   ...
   *            recorder provides status and capabilities information as well as
   *            functions to manipulate the recorder.<br>
   *            <br>
   *            Usage of the recorder varies slightly from the general AIRMobile
   *            functions with regards to asychronous callbacks. When using the
   *            recorder, callbacks are event based rather than singleing out
   *            individual requests. When specifying an 'event handler' with one
   *            of the recorder functions such as <code>initialize</code>,
   *            the function specified will be registered for one or more
   *            events. It is up to the caller to unregister when they are no
   *            longer interested in the event(s). Additionally, any parameters
   *            the event may have will be specified using MessageEvents, where
   *            the message value contains the data (json encoded if necessary).
   */
  AIRMobile.recorder = {
    /**
    ...
    EVENT_START : "START",
    /**
     * Event indicating a progress event has occurred (30kb audio captured etc).
     * 
     * @constant
     */
     ...
     * The event contains the base 64 encoded data of the recording. This event
     * is fired as a MessageEvent where the message value contains a JSON string
     * representing the recorded data.<br>
     * <code>
     *  {<br>
    ...
    /**
     * Status indicating the device is encountered an error and a reinitialize
     * is required.
     * 
     * @constant
     */
    STATUS_ERROR : "ERROR",
    /**
     * Status indicating the device is done recording and final book keeping and
     * generation of encoded audio is in progress.
     * 
     * @constant
     */
    ...
    /**
     * Request that the device initialize the audio recorder system. Sends an
     * asynchronous request to the device. If an event listener is specified,
     * the function will be registered for the following events:
     * <ul>
     ...
     * 
     * @param {function}
     *          eventHandler The event handler to register for correstponding
     *          events.
     * @return {String} The unique identifier for the request which was sent to
     *         the device.
     */
    initialize : function(_eventListener) {
      ...
      AIRMobile.listen(AIRMobile.recorder.EVENT_INITIALIZING, document,
          _eventListener);
      AIRMobile
          .listen(AIRMobile.recorder.EVENT_READY, document, _eventListener);
      AIRMobile
          .listen(AIRMobile.recorder.EVENT_ERROR, document, _eventListener);
      ...
      AIRMobile.sendToApp(AIRMobile.recorder.CMD_INITIALIZE_RECORDER, JSON
          .stringify(params, null, true));
     ...
     * @config {Object} progressFrequency an object containing properties for
     *         type and interval type should be one of either "size" or "time",
     *         interval should be an integer corresponding to kilobytes, or
     *         seconds, respectively.
     * @param {function}
     *          eventListener The event handler to register for corresponding
     *          events:
     *          <ul>
     *          <li>EVENT_START</li>
     *          <li>EVENT_END</li>
    ...
    startCapture : function(_options, _eventListener) {
      if (this.status == AIRMobile.recorder.STATUS_IDLE) {
        ...
        if (errorMessage == null) {
          ...
          AIRMobile.listen(this.EVENT_START, document, _eventListener, true);
          AIRMobile.listen(this.EVENT_END, document, _eventListener, true);
          // AIRMobile.listen(this.EVENT_INPROGRESS, document,
          // _eventListener);
          AIRMobile.listen(this.EVENT_ERROR, document, _eventListener, true);

          this.status = this.STATUS_ACTIVE;
          AIRMobile.dispatchEvent(this.EVENT_START);
          AIRMobile.sendToApp(AIRMobile.recorder.CMD_START_AUDIO_CAPTURE, JSON
    ...
    stopCapture : function() {
      ...
      if (this.status == AIRMobile.recorder.STATUS_ACTIVE) {
        AIRMobile.sendToApp(AIRMobile.recorder.CMD_END_AUDIO_CAPTURE, JSON
            .stringify(params, null, true));
        return true;
      } else {
        return false;
     ...
     * 
     * @param {Object}
     *          audioData object containing information on what audio to play
     * @config {String} type the type of audio info either 'filename' or
     *         'filedata'
     * @config {String} data the data, this should either by the base64 encoded
     *         file, or the filename
     * @config {String} filename the filename (used to save the base64 data to
     *         disk) Example <code>
     *  {
     *      type : 'filename',
     *      data : 'myfile.opus',
     ...
     *  </code>
     * @param {function}
     *          eventListener the handler to invoke when playback events are
     *          fired.
     * @return {Boolean} indicate whether the command has been sent to the
     *         device.
     */
    play : function(_audioData, _eventListener) {
      ...
      if (this.playbackStatus == this.PLAYBACK_STATE_IDLE) {
        AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_START, document,
            _eventListener, true);
        AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_END, document,
            _eventListener, true);
        ...
        // document, _eventListener);
        AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_STOPPED, document,
            _eventListener, true);
        AIRMobile.listen(AIRMobile.recorder.EVENT_PLAYBACK_ERROR, document,
            _eventListener, true);

        AIRMobile.sendToApp(this.CMD_PLAY_AUDIO, JSON.stringify(params, null,
            true));
    ...
    stopPlay : function() {
      ...
      AIRMobile.sendToApp(this.CMD_STOP_PLAYBACK, JSON.stringify(params, null,
          true));
      return true;
    },
    ...
    pausePlay : function() {
      ...
      AIRMobile.sendToApp(this.CMD_PAUSE_PLAYBACK, JSON.stringify(params, null,
          true));
      return true;
    },
    ...
    resumePlay : function() {
      ...
      AIRMobile.sendToApp(this.CMD_RESUME_PLAYBACK, JSON.stringify(params,
          null, true));
      return true;
    },
    ...
    retrieveAudioFile : function(_fileIdentifier, _callback) {
      ...
      AIRMobile.sendToApp(this.CMD_REQUEST_AUDIO_FILE, JSON.stringify(params,
          null, true));
    },
    ...
    clearAudioFileCache : function(_callback) {
      ...
      AIRMobile.sendToApp(this.CMD_CLEAR_AUDIO_CACHE, JSON.stringify(params,
          null, true));
    },
     ...
     *          response. The callback should take a single parameter, an object
     *          which will have a property 'files', an array of file names.
     */
    retrieveAudioFileList : function(_callback) {
      ...
      AIRMobile.sendToApp(this.CMD_REQUEST_AUDIO_FILE_LIST, JSON.stringify(
          params, null, true));
    },
     ...
     *          AIRMobile.recorder settings. If an invalid option is found, a
     *          corresponding error message is returned. Otherwise 'null' is
     *          returned.
    ...
    /**
     * @ignore
     * @private Determine if the deviceID provided is valid based on the current
    ...
    checkPermissionStatus : function(callback) {
      ...
      AIRMobile.sendToApp(this.CMD_CHECK_PERMISSION_STATUS, JSON.stringify(
          params, null, true));
    }
  };
   ...
   * <br>
   * Make sure to remove console logs from production to avoid unnecessary back
   * and forth with the device.
   */
  var console = {
    /** Log */
    log : function(log) {
