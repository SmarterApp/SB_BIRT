Test = Test8 = (function() {
  ...
  var NO = 0, YES = 1, OLD = 2, BUGGY = 4, PREFIX = 8, BLOCKED = 16, DISABLED = 32, UNCONFIRMED = 64, UNKNOWN = 128, EXPERIMENTAL = 256;
  ...
  var testsuite = [
      ...
      function(results) {
        ...
        try {
          ...
          result &= e.firstChild.attributes[0].nodeName == "foo<bar"
              || e.firstChild.attributes[0].name == "foo<bar";
          ...
          e.innerHTML = "<div \"foo=''>";
          result &= e.firstChild
              && (e.firstChild.attributes[0].nodeName == "\"foo" || e.firstChild.attributes[0].name == "\"foo");
          ...
          result &= e.firstChild
              ...
              && e.firstChild.nodeValue == '?import namespace="foo" implementation="#bar"';

          e.innerHTML = '<!--foo--bar-->';
          result &= e.firstChild && e.firstChild.nodeType == 8
              && e.firstChild.nodeValue == 'foo--bar';

          e.innerHTML = '<![CDATA[x]]>';
          result &= e.firstChild && e.firstChild.nodeType == 8
              && e.firstChild.nodeValue == '[CDATA[x]]';

          e.innerHTML = "<textarea><!--</textarea>--></textarea>";
          result &= e.firstChild && e.firstChild.firstChild
      ...
      function(results) {
        ...
        try {
          ...
          h.innerHTML = "";
          result &= h.firstChild && h.firstChild.nodeName == "HEAD"
              && h.lastChild.nodeName == "BODY"
              && h.firstChild.nextSibling == h.lastChild;
        } catch (e) {
          result = false;
        }
        ...
        result &= e.firstChild && e.firstChild.firstChild
            && e.firstChild.firstChild.firstChild
            && e.firstChild.firstChild.firstChild.nodeValue == "A ";

        e.innerHTML = "<table><form><input type=hidden><input></form><div></div></table>";
        result &= e.firstChild && e.firstChild.nodeName == "INPUT"
        ...
        result &= e.firstChild && e.childNodes.length == 3
        ...
        e.innerHTML = "<div></div>";
        result &= e.firstChild && "namespaceURI" in e.firstChild
            && e.firstChild.namespaceURI == "http://www.w3.org/1999/xhtml";
      ...
      function(results) {
        var e = document.createElement('div');
        e.innerHTML = '<svg></svg>';
        var passed = e.firstChild && "namespaceURI" in e.firstChild
            && e.firstChild.namespaceURI == 'http://www.w3.org/2000/svg';
      ...
      function(results) {
        ...
        for (var e = 0; e < elements.length; e++) {
          ...
          try {
            ...
            try {
              passed = element instanceof HTMLElement
                  && !(element instanceof HTMLUnknownElement)
                  && isBlock(element) && closesImplicitly(elements[e]);
            } catch (error) {
            }
          ...
          try {
            ...
            try {
              passed = element instanceof HTMLElement
                  && !(element instanceof HTMLUnknownElement)
                  && isBlock(element)
                  && (elements[e] != 'figure' || closesImplicitly(elements[e]));
            } catch (error) {
            }
      ...
      function(results) {
        ...
        try {
          rubySupport = rubyElement && rubyElement instanceof HTMLElement
              && !(rubyElement instanceof HTMLUnknownElement);
          rtSupport = rtElement && rtElement instanceof HTMLElement
              && !(rtElement instanceof HTMLUnknownElement);
          rpSupport = rpElement && rpElement instanceof HTMLElement
              && !(rpElement instanceof HTMLUnknownElement)
              && isHidden(rpElement);
        } catch (error) {
        }
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = typeof HTMLTimeElement != 'undefined'
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = typeof HTMLDataElement != 'undefined'
      ...
      function(results) {
        ...
        try {
          ...
          try {
            legacy = typeof HTMLMenuElement != 'undefined'
                && element instanceof HTMLMenuElement && 'type' in element;
          } catch (error) {
          }

          // Check default type
          if (legacy && element.type != 'list')
            legacy = false;
        ...
        try {
          ...
          try {
            passed = typeof HTMLMenuElement != 'undefined'
                && element instanceof HTMLMenuElement && 'type' in element;
          } catch (error) {
          }

          // Check default type
          if (passed && element.type != 'toolbar')
            passed = false;
      ...
      function(results) {
        ...
        try {
          ...
          if (legacy) {
            ...
            if (typeof HTMLMenuItemElement == 'undefined'
                || !item instanceof HTMLMenuItemElement)
              legacy = false;
          }
        ...
        try {
          ...
          if (passed && second.type == 'list')
            legacy = true;
          if (passed && second.type != 'context')
            passed = false;
          ...
          if (passed && element.type != 'context')
            passed = false;
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = typeof HTMLDialogElement != 'undefined'
      ...
      function(results) {
        var types = [ 'date', 'month', 'week', 'time', 'datetime',
            'datetime-local' ];
        for (var t = 0; t < types.length; t++) {
          ...
          results.addItem({
            key : 'form.' + types[t] + '.ui',
            passed : minimal && sanitization // Testing UI reliably is not
                                              // possible, so we assume if
                                              // sanitization is support we also
                                              // have a UI and use the blacklist
                                              // to make corrections
          });
      ...
      function(results) {
        ...
        results.addItem({
          key : 'form.color.ui',
          passed : sanitization
        // Testing UI reliably is not possible, so we assume if sanitization is
        // support we also have a UI and use the blacklist to make corrections
        });
      ...
      function(results) {
        ...
        var passed = false;
        try {
          passed = typeof HTMLTextAreaElement != 'undefined'
      ...
      function(results) {
        ...
        var passed = false;
        try {
          passed = typeof HTMLSelectElement != 'undefined'
      ...
      function(results) {
        ...
        var passed = false;
        try {
          passed = typeof HTMLFieldSetElement != 'undefined'
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = (typeof HTMLDataListElement != 'undefined' && element instanceof HTMLDataListElement)
      ...
      function(results) {
        ...
        var passed = false;
        try {
          passed = typeof HTMLKeygenElement != 'undefined'
              && element.firstChild instanceof HTMLKeygenElement
              && 'challenge' in element.firstChild
              && 'keytype' in element.firstChild;
        } catch (error) {
        }
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = typeof HTMLOutputElement != 'undefined'
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = typeof HTMLProgressElement != 'undefined'
      ...
      function(results) {
        ...
        try {
          ...
          try {
            passed = typeof HTMLMeterElement != 'undefined'
      ...
      function(results) {
        var props = 'formAction formEnctype formMethod formNoValidate formTarget'
            .split(' ');
      ...
      /*
       * valid, invalid, optional, required, in-range, out-of-range, read-write
       * and read-only css selectors
       */

      function(results) {
        var selectors = "valid invalid optional required in-range out-of-range read-write read-only"
            .split(" ");
        var passed = [ NO | UNKNOWN, NO | UNKNOWN, NO | UNKNOWN, NO | UNKNOWN,
            NO | UNKNOWN, NO | UNKNOWN, NO | UNKNOWN, NO | UNKNOWN ];

        /*
         * At this time we are not testing enabled, disabled, checked and
         * indeterminate, because these selectors are part of the CSS 3 Selector
         * specification and universally implemented, see
        ...
        if ('querySelector' in document) {
          ...
          try {
            ...
            try {
              passed[6] = document
                  .querySelector("#testFormInput:-moz-read-write") ? YES
                  | PREFIX : NO;
            } catch (e) {
            }
          }
          ...
          try {
            ...
            try {
              passed[7] = document
                  .querySelector("#testFormInput:-moz-read-only") ? YES
                  | PREFIX : NO;
            } catch (e) {
            }
          }
      ...
      function(results) {
        ...
        try {
          ...
          if (event.initKeyEvent) {
            event.initKeyEvent("keypress", false, true, null, false, false,
                false, false, null, 65);
      ...
      function(results) {
        ...
        passed = passed && !!('itemValue' in property)
            && property.itemValue == 'Elizabeth';

        // Check the element that is the item
        passed = passed && !!('properties' in item)
            && item.properties['name'][0].itemValue == 'Elizabeth';

        // Check the getItems method
        if (!!document.getItems) {
          var user = document.getItems('http://example.net/user')[0];
          passed = passed
              && user.properties['name'][0].itemValue == 'Elizabeth';
        }
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!document.documentElement.requestFullscreen ? YES
              : !!document.documentElement.webkitRequestFullScreen
                  || !!document.documentElement.mozRequestFullScreen
                  || !!document.documentElement.msRequestFullscreen ? YES
                  | PREFIX : NO
        });
      },
      ...
      function(results) {
        results
            .addItem({
              ...
              passed : 'Notification' in window ? YES
                  : 'webkitNotifications' in window
                      || 'mozNotification' in window.navigator
                      || 'oNotification' in window
                      || 'msNotification' in window ? YES | PREFIX : NO
            });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!navigator.mediaDevices
              ...
              : !!navigator.getUserMedia ? YES | OLD
                  : !!navigator.webkitGetUserMedia
                      || !!navigator.mozGetUserMedia
                      || !!navigator.msGetUserMedia
                      || !!navigator.oGetUserMedia ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!navigator.mediaDevices
              && !!navigator.mediaDevices.getDisplayMedia ? YES : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!navigator.mediaDevices
              && !!navigator.mediaDevices.enumerateDevices ? YES : NO
        });
      },
      ...
      function(results) {
        results
            .addItem({
              ...
              passed : !!navigator.getGamepads ? YES
                  : !!navigator.webkitGetGamepads || !!navigator.mozGetGamepads
                      || !!navigator.msGetGamepads || !!navigator.oGetGamepads ? YES
                      | PREFIX
                      : NO
            });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'pointerLockElement' in document ? YES
              : 'oPointerLockElement' in document
                  || 'msPointerLockElement' in document
                  || 'mozPointerLockElement' in document
                  || 'webkitPointerLockElement' in document ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!window.PointerEvent ? YES : !!window.webkitPointerEvent
              || !!window.mozPointerEvent || !!window.msPointerEvent
              || !!window.oPointerEvent ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'Promise' in window && typeof window.fetch === 'function'
      ...
      function(results) {
        ...
        xhr.onreadystatechange = function() {
          if (this.readyState == 4 && !done) {
            ...
            try {
              passed = !!(this.responseText); // && this.responseText ==
                                              // '<title>&amp;&<</title>');
            } catch (e) {
            }
        ...
        try {
          ...
          xhr.open("GET", "../html5test/assets/detect.html?"
      ...
      function(results) {
        ...
        if (!window.XMLHttpRequest || !window.ArrayBuffer)
          return;
      ...
      function(results) {
        ...
        var passed = 'WebSocket' in window ? YES
            : 'MozWebSocket' in window ? YES | PREFIX : NO;
        if (websocket && websocket.CLOSING !== 2)
          passed |= OLD;
      ...
      function(results) {
        results.addItem({
          key : 'rtc.webrtc',
          passed : !!window.RTCPeerConnection ? YES
              : !!window.webkitRTCPeerConnection
                  || !!window.mozRTCPeerConnection
                  || !!window.msRTCPeerConnection
                  || !!window.oRTCPeerConnection ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results
            .addItem({
              key : 'rtc.objectrtc',
              passed : !!window.RTCIceTransport ? YES
                  : !!window.webkitRTCIceTransport
                      || !!window.mozRTCIceTransport
                      || !!window.msRTCIceTransport
                      || !!window.oRTCIceTransport ? YES | PREFIX : NO
            });
      },
      ...
      function(results) {
        var passed = false;
        try {
          o = new (window.RTCPeerConnection || window.msRTCPeerConnection
        ...
        results.addItem({
          key : 'rtc.datachannel',
          passed : passed ? (window.RTCPeerConnection ? YES : YES | PREFIX)
              : NO
        });
      },
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : 'dropzone' in element ? YES : 'webkitdropzone' in element
              || 'mozdropzone' in element || 'msdropzone' in element
              || 'odropzone' in element ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        ...
        /*
         * We need to check if the draggable attribute is supported, because
         * older versions of IE do support the incompatible versions of the
         * events below. IE 9 and up do support the HTML5 events in combination
         * with the draggable attribute
         */
      ...
      function(results) {
        ...
        if ('querySelector' in document) {
          ...
          try {
            ...
            try {
              passed[0] = document
                  .querySelector("#testDivElement:-moz-read-write") == element ? YES
                  | PREFIX
                  : NO;
            } catch (e) {
            }
          ...
          try {
            ...
            try {
              passed[1] = document
                  .querySelector("#testDivNested:-moz-read-only") == nested ? YES
                  | PREFIX
                  : NO;
            } catch (e) {
            }
      ...
      function(results) {
        var passed = NO;
        try {
          var crypto = window.crypto || window.webkitCrypto || window.mozCrypto
              || window.msCrypto || window.oCrypto;
          var available = window.crypto ? YES : window.mozCrypto
              || window.msCrypto || window.oCrypto ? YES | PREFIX : NO;
          passed = !!crypto && 'subtle' in crypto ? available : !!crypto
              && 'webkitSubtle' in crypto ? YES | PREFIX : NO;
        } catch (e) {
        }
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'webauthn' in window ? YES : 'msCredentials' in window ? YES
              | OLD : NO
        });
      },
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'video/mp4; codecs="mp4v.20.8"')
        });

        /* h.264 codec */

        /*
         * I added a workaround for IE9, which only detects H.264 if you also
         * provide an audio codec. Bug filed @ connect.microsoft.com
         */
        ...
        results
            .addItem({
              ...
              passed : !!element.canPlayType
                  && (canPlayType(element, 'video/mp4; codecs="avc1.42E01E"') || canPlayType(
                      element, 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"'))
            });
        ...
        results
            .addItem({
              ...
              passed : !!element.canPlayType
                  && (canPlayType(element, 'video/mp4; codecs="hvc1.1.L0.0"') || canPlayType(
                      element, 'video/mp4; codecs="hev1.1.L0.0"'))
            });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'video/ogg; codecs="theora"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'video/webm; codecs="vp8"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'video/webm; codecs="vp9"')
        });
        ...
        if (!!element.canPlayType) {
          ...
          if (element.canPlayType('video/mp4; codecs="avc1.42E01E"') == 'maybe'
              && element.canPlayType('video/mp4') == 'probably') {
            passed = false;
            log('BUGGY: Codec detection bug in iOS 4.1 and earlier that switches "maybe" and "probably" around')
          }

          if (element.canPlayType('video/mp4; codecs="avc1.42E01E"') == 'maybe'
              && element.canPlayType('video/mp4') == 'maybe') {
            passed = false;
            log('BUGGY: Codec detection bug in Android where no better answer than "maybe" is given')
          }

          if (element.canPlayType('video/mp4; codecs="avc1.42E01E, mp4a.40.2"') == 'probably'
              && element.canPlayType('video/mp4; codecs="avc1.42E01E"') != 'probably') {
            passed = false;
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/wav; codecs="1"')
        });
        ...
        if (element.canPlayType) {
          ...
          if (t == 'maybe') {
            // We need to check if the browser really supports playing MP3s by
            // loading one and seeing if the
            // loadedmetadata event is triggered... but for now assume it does
            // support it...
            r = true;
          } else if (t == 'probably') {
            r = true;
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/mp4; codecs="mp4a.40.2"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/mp4; codecs="ac-3"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/mp4; codecs="ec-3"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/ogg; codecs="vorbis"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/ogg; codecs="opus"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/webm; codecs="vorbis"')
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && canPlayType(element, 'audio/webm; codecs="opus"')
        });
      },
      ...
      function(results) {
        results
            .addItem({
              key : 'audio.webaudio',
              passed : 'AudioContext' in window ? YES
                  : 'webkitAudioContext' in window
                      || 'mozAudioContext' in window
                      || 'oAudioContext' in window
                      || 'msAudioContext' in window ? YES | PREFIX : NO
            });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'SpeechRecognition' in window ? YES
              : 'webkitSpeechRecognition' in window
                  || 'mozSpeechRecognition' in window
                  || 'oSpeechRecognition' in window
                  || 'msSpeechRecognition' in window ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        var speechSynthesis = window.speechSynthesis
            || window.webkitSpeechSynthesis || window.mozSpeechSynthesis
            || window.oSpeechSynthesis || window.msSpeechSynthesis;
        var available = 'speechSynthesis' in window ? YES
            : 'webkitSpeechSynthesis' in window
                || 'mozSpeechSynthesis' in window
                || 'oSpeechSynthesis' in window
                || 'msSpeechSynthesis' in window ? YES | PREFIX : NO;
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window ? YES
              : 'WebKitMediaSource' in window || 'mozMediaSource' in window
                  || 'msMediaSource' in window ? YES | PREFIX : NO
        });
        ...
        results.addItem({
          key : 'streaming.drm',
          passed : 'setMediaKeys' in element ? YES
              : 'webkitAddKey' in element || 'webkitSetMediaKeys' in element
                  || 'mozSetMediaKeys' in element
                  || 'msSetMediaKeys' in element ? YES | PREFIX : NO
        });
        ...
        results.addItem({
          ...
          passed : !!element.canPlayType
              && element.canPlayType('application/dash+xml') != ''
        });
        ...
        results
            .addItem({
              ...
              passed : !!element.canPlayType
                  && (element.canPlayType('application/vnd.apple.mpegURL') != '' || element
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window
              && MediaSource.isTypeSupported('video/mp4; codecs="mp4v.20.8"')
        });
        ...
        results
            .addItem({
              ...
              passed : 'MediaSource' in window
                  && (MediaSource
                      .isTypeSupported('video/mp4; codecs="hvc1.1.L0.0"') || MediaSource
                      .isTypeSupported('video/mp4; codecs="hev1.1.L0.0"'))
            });
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window
              && MediaSource
                  .isTypeSupported('video/mp2t; codecs="avc1.42E01E"')
        });
        ...
        results
            .addItem({
              ...
              passed : 'MediaSource' in window
                  && (MediaSource
                      .isTypeSupported('video/mp2t; codecs="hvc1.1.L0.0"') || MediaSource
                      .isTypeSupported('video/mp2t; codecs="hev1.1.L0.0"'))
            });
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window
              && MediaSource.isTypeSupported('video/ogg; codecs="theora"')
        });
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window
              && MediaSource.isTypeSupported('audio/mp2t; codecs="mp4a.40.2"')
        });
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window
              && MediaSource.isTypeSupported('audio/mp2t; codecs="ac-3"')
        });
        ...
        results.addItem({
          ...
          passed : 'MediaSource' in window
              && MediaSource.isTypeSupported('audio/mp2t; codecs="ec-3"')
        });
      ...
      function(results) {
        ...
        results.addItem({
          key : 'canvas.context',
          passed : !!(canvas.getContext
              && typeof CanvasRenderingContext2D != 'undefined' && canvas
              .getContext('2d') instanceof CanvasRenderingContext2D)
        });
      },
      ...
      function(results) {
        results.addItem({
          key : 'canvas.path',
          passed : typeof Path2D != "undefined" ? YES
              : typeof Path != "undefined" ? YES | OLD : NO
        });
      },
      ...
      function(results) {
        ...
        if (canvas.getContext) {
          ...
          try {
            ...
            passed = ctx.globalCompositeOperation == 'screen'
                && data.data[0] == 255;
          } catch (e) {
          }
        }
      ...
      function(results) {
        ...
        var contexts = [ 'webgl', 'experimental-webgl', 'ms-webgl',
            'moz-webgl', 'opera-3d', 'webkit-3d', 'ms-3d', '3d' ];
        var context = '';
        var enabled = false;
        ...
        results.addItem({
          key : '3d.webgl',
          passed : enabled ? (context == 'webgl' ? YES
              : (context == 'experimental-webgl' ? YES | EXPERIMENTAL : YES
                  | PREFIX)) : (passed ? YES | DISABLED : NO)
        });
      },
      ...
      function(results) {
        ...
        results.addItem({
          key : '3d.webgl2',
          passed : enabled ? (context == 'webgl2' ? YES
              : (context == 'experimental-webgl2' ? YES | EXPERIMENTAL : YES
                  | PREFIX)) : (passed ? YES | DISABLED : NO)
        });
      },
      ...
      function(results) {
        results.addItem({
          key : '3d.webvr',
          passed : 'getVRDisplays' in navigator ? YES
              : 'mozGetVRDevices' in navigator ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!window.requestAnimationFrame ? YES
              : !!window.webkitRequestAnimationFrame
                  || !!window.mozRequestAnimationFrame
                  || !!window.msRequestAnimationFrame
                  || !!window.oRequestAnimationFrame ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        ...
        try {
          ...
          /*
           * If we get a security exception we know the feature exists, but
      ...
      function(results) {
        ...
        try {
          ...
          passed = !!window.indexedDB ? YES : !!window.webkitIndexedDB
              || !!window.mozIndexedDB || !!window.moz_indexedDB
              || !!window.oIndexedDB || !!window.msIndexedDB ? YES | PREFIX
              : NO;
      ...
      function(results) {
        ...
        results.addItem({
          ...
          passed : 'FileReader' in window
              && 'readAsArrayBuffer' in (new FileReader())
        });
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!window.requestFileSystem ? YES
              : !!window.webkitRequestFileSystem
                  || !!window.mozRequestFileSystem
                  || !!window.oRequestFileSystem
                  || !!window.msRequestFileSystem ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : !!navigator.getFileSystem ? YES
              : !!navigator.webkitGetFileSystem || !!navigator.mozGetFileSystem
                  || !!window.msGetFileSystem ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results
            .addItem({
              ...
              passed : 'attachShadow' in document.createElement('div') ? YES
                  : 'createShadowRoot' in document.createElement('div')
                      || 'webkitCreateShadowRoot' in document
                          .createElement('div') ? YES | OLD : NO
            });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'MutationObserver' in window ? YES
              : 'WebKitMutationObserver' in window
                  || 'MozMutationObserver' in window
                  || 'oMutationObserver' in window
                  || 'msMutationObserver' in window ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          key : 'scripting.url',
          passed : 'URL' in window ? YES
              : 'WebKitURL' in window || 'MozURL' in window || 'oURL' in window
                  || 'msURL' in window ? YES | PREFIX : NO
        });
      },
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'TextEncoder' in window && 'TextDecoder' in window ? YES
              : NO
        });
      },
      ...
      function(results) {
        ...
        var passed = !!(Date.now && Date.prototype
            && Date.prototype.toISOString && Date.prototype.toJSON && canParseISODate);
      ...
      function(results) {
        var passed = !!(Object.keys && Object.create && Object.getPrototypeOf
            && Object.getOwnPropertyNames && Object.isSealed && Object.isFrozen
            && Object.isExtensible && Object.getOwnPropertyDescriptor
            && Object.defineProperty && Object.defineProperties && Object.seal
      ...
      function(results) {
        ...
        if ('Promise' in window && 'resolve' in window.Promise
            ...
            && 'race' in window.Promise && (function() {
              var resolve;
      ...
      function(results) {
        var passed = typeof Map !== 'undefined'
            && typeof WeakMap !== 'undefined' && typeof Set !== 'undefined'
      ...
      function(results) {
        var passed = !!(Number.isFinite && Number.isInteger
            && Number.isSafeInteger && Number.isNaN && Number.parseInt
            && Number.parseFloat && Number.isInteger(Number.MAX_SAFE_INTEGER)
            && Number.isInteger(Number.MIN_SAFE_INTEGER) && Number
            .isFinite(Number.EPSILON));
      ...
      function(results) {
        var passed = !!(Object.assign && Object.is && Object.setPrototypeOf);
      ...
      function(results) {
        var passed = !!(Math && Math.clz32 && Math.cbrt && Math.imul
            && Math.sign && Math.log10 && Math.log2 && Math.log1p && Math.expm1
            && Math.cosh && Math.sinh && Math.tanh && Math.acosh && Math.asinh
            && Math.atanh && Math.hypot && Math.trunc && Math.fround);
      ...
      function(results) {
        ...
        var callback = item
            .getGlobalCallback(function(scoped) {
              item.update({
        ...
        var s = document.createElement('script');
        s.type = 'module';
        s.src = "data:text/javascript;charset=utf-8,var test_module_scope = true; window."
            + callback + "(typeof window.test_module_scope === 'undefined')";
        document.body.appendChild(s);
      ...
      function(results) {
        results.addItem({
          ...
          passed : 'visibilityState' in document ? YES
              : 'webkitVisibilityState' in document
                  || 'mozVisibilityState' in document
                  || 'oVisibilityState' in document
                  || 'msVisibilityState' in document ? YES | PREFIX : NO
        });
      },
  ...
  var canPlayType = function(element, type) {
    /*
     * There is a bug in iOS 4.1 or earlier where probably and maybe are
     * switched around. This bug was reported and fixed in iOS 4.2
     */

    if (Browsers.isOs('iOS', '<', '4.2'))
      return element.canPlayType(type) == 'probably'
          || element.canPlayType(type) == 'maybe';
    else
      return element.canPlayType(type) == 'probably';
  };
  ...
  List.prototype = {
    ...
    toString : function() {
      ...
      for (var i = 0; i < this.items.length; i++) {
        if (typeof this.items[i].data.passed != 'undefined')
          value.push(this.items[i].data.key + '='
              + (+this.items[i].data.passed));
      }
  ...
  Item.prototype = {
    initialize : function(list, data) {
      ...
      if (typeof this.data.passed == 'undefined')
    ...
    getGlobalCallback : function(callback) {
      var uniqueid = (((1 + Math.random()) * 0x1000000) | 0).toString(16)
          .substring(1);
  ...
  function Runner(callback, error) {
    this.initialize(callback, error);
  }
  Runner.prototype = {
    initialize : function(callback, error) {
      blacklists = [
          [
              BLOCKED,
              {
                'form.file' : Browsers.isDevice('Xbox 360')
                    || Browsers.isDevice('Xbox One')
                    || Browsers.isDevice('Playstation 4')
                    || Browsers.isOs('Windows Phone', '<', '8.1')
                    || Browsers.isOs('iOS', '<', '6')
                    || Browsers.isOs('Android', '<', '2.2'),
                'form.date.ui' : Browsers.isBrowser('Sogou Explorer')
                    || Browsers.isBrowser('Maxthon', '<', '4.0.5')
                    || (Browsers.isBrowser('UC Browser', '<', '8.6') && Browsers
                        .isType('mobile', 'tablet')),
                'form.month.ui' : Browsers.isBrowser('Sogou Explorer')
                    || Browsers.isBrowser('Maxthon', '<', '4.0.5')
                    || (Browsers.isBrowser('UC Browser', '<', '8.6') && Browsers
                        .isType('mobile', 'tablet')),
                'form.week.ui' : Browsers.isBrowser('Sogou Explorer')
                    || Browsers.isBrowser('Maxthon', '<', '4.0.5')
                    || (Browsers.isBrowser('UC Browser', '<', '8.6') && Browsers
                        .isType('mobile', 'tablet')),
                'form.time.ui' : Browsers.isBrowser('Sogou Explorer')
                    || Browsers.isBrowser('Maxthon', '<', '4.0.5')
                    || (Browsers.isBrowser('UC Browser', '<', '8.6') && Browsers
                        .isType('mobile', 'tablet')),
                'form.datetime-local.ui' : Browsers.isBrowser('Sogou Explorer')
                    || Browsers.isBrowser('Maxthon', '<', '4.0.5')
                    || (Browsers.isBrowser('UC Browser', '<', '8.6') && Browsers
                        .isType('mobile', 'tablet')),
                'form.color.ui' : Browsers.isBrowser('Sogou Explorer')
                    || (Browsers.isBrowser('UC Browser', '<', '9.8') && Browsers
                        .isType('mobile', 'tablet')),
                'form.range.ui' : (Browsers.isBrowser('UC Browser', '<', '9.8') && Browsers
                    .isType('mobile', 'tablet')),
                'form.progress.element' : Browsers.isBrowser('Baidu Browser'),
                'files.fileSystem' : Browsers.isOs('BlackBerry Tablet OS'),
                'input.getUserMedia' : Browsers.isDevice('webOS TV')
                    || Browsers.isBrowser('Baidu Browser')
                    || Browsers.isBrowser('Sogou Explorer')
                    || (Browsers.isBrowser('UC Browser', '<', '9.8') && Browsers
                        .isType('mobile', 'tablet'))
                    || Browsers.isBrowser('Dolphin')
                    || Browsers.isBrowser('Safari', '=', '9'),
                'input.getGamepads' : Browsers.isDevice('webOS TV')
                    || Browsers.isDevice('Playstation 4')
                    || Browsers.isDevice('Wii U'),
                'location.geolocation' : Browsers.isDevice('webOS TV')
                    || Browsers.isDevice('Xbox One')
                    || Browsers.isBrowser('Baidu Browser')
                    || Browsers.isOs('Google TV'),
                'location.orientation' : Browsers.isBrowser('Baidu Browser'),
                'output.notifications' : Browsers.isBrowser('Opera', '=', '18')
                    || Browsers.isBrowser('Baidu Browser')
                    || Browsers.isBrowser('Sogou Explorer'),
                'output.requestFullScreen' : Browsers
                    .isBrowser('Sogou Explorer')
                    || Browsers.isOs('BlackBerry Tablet OS')
                    || Browsers.isOs('BlackBerry OS'),
                'video.subtitle' : Browsers.isBrowser('Baidu Browser')
                    || Browsers.isBrowser('Sogou Explorer'),
          ...
          [
              DISABLED,
              {
                'elements.semantic.ping' : Browsers.isBrowser('Firefox')
                    || Browsers.isBrowser('Firefox Mobile')
              } ],
          ...
          [
              UNCONFIRMED,
              {
                'interaction.dragdrop' : !(Browsers.isType('desktop')
                    ...
                    && (Browsers.isBrowser('Opera') && Browsers
                        .isEngine('Presto')) || Browsers.isType('television')
                ...
                'interaction.editing' : !(Browsers.isType('desktop')
                    ...
                    && (Browsers.isOs('iOS', '>=', '5')
                        ...
                        || Browsers.isOs('BlackBerry OS')
                        || Browsers.isOs('BlackBerry Tablet OS')
                        || Browsers.isOs('Meego') || Browsers.isOs('Tizen')
                        || Browsers.isEngine('Gecko')
                        || Browsers.isEngine('Presto')
                        || Browsers.isBrowser('Chrome') || Browsers.isBrowser(
                        'Polaris', '>=', '8'))
                    || Browsers.isType('television')
                    && (Browsers.isOs('Tizen') || Browsers.isDevice('webOS TV')
                        || Browsers.isBrowser('Espial')
                        || Browsers.isBrowser('MachBlue XT') || Browsers
                        .isEngine('Presto', '>=', '2.9')) || Browsers
                    .isType('gaming')
                    && (Browsers.isDevice('Xbox 360')
                        || Browsers.isDevice('Xbox One') || Browsers
                        .isDevice('Playstation 4')))
              } ] ];
    ...
    checkForBackground : function() {
      ...
      for (var task = 0; task < this.backgroundTasks.length; task++) {
        running += this.backgroundTasks[task]
      }
    ...
    finished : function() {
      var uniqueid = (((1 + Math.random()) * 0x1000000) | 0).toString(16)
          .substring(1)
          + ("0000000000" + (new Date().getTime() - new Date(2010, 0, 1)
              .getTime()).toString(16)).slice(-10);
