                ...
                },
                {
                  ...
                  items : [
                      ...
                      },
                      {
                        ...
                        urls : [
                            [ 'w3c',
                                'http://www.w3.org/TR/html5/text-level-semantics.html#the-data-element' ],
                            [ 'whatwg',
                  ...
                  items : [
                      ...
                      },
                      {
                        ...
                        urls : [
                            [
                                'w3c',
                                'http://www.w3.org/html/wg/drafts/html/master/single-page.html#the-dialog-element' ],
                            [ 'whatwg',
                ...
                },
                {
                  ...
                  items : [
                      ...
                      },
                      {
                        ...
                        urls : [ [
                            'w3c',
                            'https://dvcs.w3.org/hg/innerhtml/raw-file/tip/index.html#widl-Element-insertAdjacentHTML-void-DOMString-position-DOMString-text' ] ]
                      } ]
                } ]
          },
          {
            ...
            items : [
                {
                  ...
                  name : 'Geolocation',
                  value : 15,
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/geolocation-API/' ],
                      [ 'wp', '/apis/geolocation' ],
          ...
          },
          {
            ...
            items : [
                ...
                },
                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/notifications/' ],
            ...
            items : [
                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/gamepad/' ],
                      [ 'wp', '/apis/gamepad' ] ]
                },
                {
                  id : 'pointerevents',
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/pointerevents/' ],
      ...
      items : [
          {
            ...
            items : [
                ...
                },
                {
                  ...
                  value : 2,
                  urls : [ [ 'w3c',
                      'http://www.w3.org/TR/html5/embedded-content-0.html#dom-media-audiotracks' ] ]
                },
                {
                  id : 'videotracks',
                  ...
                  value : 2,
                  urls : [ [ 'w3c',
                      'http://www.w3.org/TR/html5/embedded-content-0.html#dom-media-videotracks' ] ]
                },
                {
                  id : 'poster',
                  name : 'Poster images',
                ...
                },
                {
                  ...
                  status : 'optional',
                  urls : [ [ 'xiph', 'http://theora.org/doc/Theora.pdf' ] ]
                },
                {
                  id : 'codecs.webm.vp8',
                  name : 'WebM with VP8 support',
                  status : 'optional',
                  urls : [ [ 'webm', 'http://www.webmproject.org/' ],
                ...
                },
                {
                  ...
                  urls : [
                      ...
                      [ 'ietf',
                          'http://tools.ietf.org/id/draft-grange-vp9-bitstream-00.txt' ] ]
                } ]
          },
          {
            id : 'audio',
            ...
            items : [
...

                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/webaudio/' ],
                      [ 'wp', '/apis/webaudio' ] ]
                },
            ...
            items : [
                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/media-source/' ],
                  ...
                  items : [
                      ...
                      },
                      {
                        ...
                        urls : [
                            [ 'webm', 'http://www.webmproject.org/' ],
                            [ 'ietf',
                                'http://www.rfc-editor.org/rfc/rfc6386.txt' ] ]
                      },
                      {
                        id : 'webm.vp9',
                        name : 'WebM with VP9 support',
            ...
            items : [
                {
                  ...
                  urls : [
                      ...
                      [
                          'w3c',
                          'http://www.w3.org/html/wg/drafts/html/master/single-page.html#the-picture-element' ],
                      [
                          'whatwg',
                ...
                },
                {
                  ...
                  urls : [
                      ...
                      [
                          'w3c',
                          'http://www.w3.org/html/wg/drafts/html/master/single-page.html#valid-source-size-list' ],
                      [ 'whatwg',
            ...
            items : [
                {
                  ...
                  value : 10,
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/2dcontext/' ],
                      [ 'wp', '/apis/canvas' ],
                ...
                },
                {
                  ...
                  urls : [
                      ...
                      [ 'whatwg',
                          'https://html.spec.whatwg.org/multipage/scripting.html#path2d-objects' ] ]
                },
                {
                  id : 'ellipse',
                  ...
                  urls : [
                      [ 'w3c',
                          'http://www.w3.org/TR/2dcontext/#dom-context-2d-ellipse' ],
                      [ 'whatwg',
                          'https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-ellipse' ] ]
                },
                {
                  id : 'dashed',
                ...
                },
                {
                  ...
                  urls : [ [
                      'whatwg',
                      'https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-drawfocusifneeded' ] ]
                },
                ...
                },
                {
                  ...
                  value : 5,
                  urls : [ [ 'w3c',
                      'http://www.w3.org/TR/compositing-1/#canvascompositingandblending' ] ]
                },
            ...
            items : [
...

                {
                  ...
                  urls : [
                      ...
                      [ 'wp', '/webgl' ], [ 'mdn', '/Web/API/WebGL_API' ] ]
            ...
            items : [
                {
                  ...
                  status : 'experimental',
                  value : 3,
                  urls : [ [ 'w3c', 'https://w3c.github.io/web-animations/' ] ]
                },
                {
      ...
      items : [
          {
            ...
            items : [
...

                {
                  ...
                  status : 'proposal',
                  value : 2,
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/beacon/' ],
...

                {
                  ...
                  status : 'proposal',
                  value : 6,
                  urls : [ [ 'whatwg', 'https://fetch.spec.whatwg.org/' ],
                ...
                },
                {
                  ...
                  urls : [ [ 'mdn', '/Web/API/XMLHttpRequest' ] ],
                  items : [
                      {
                        id : 'text',
...

                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/websockets/' ],
                ...
                },
                {
                  ...
                  urls : [
                      [ 'whatwg',
                          'https://html.spec.whatwg.org/multipage/comms.html#dom-websocket-binarytype' ],
                      [ 'mdn', '/Web/API/WebSockets_API' ] ]
                } ]
          },
          {
            ...
            items : [ {
              ...
              value : 4,
              urls : [ [ 'whatwg', 'https://streams.spec.whatwg.org/' ] ]
            }, {
              id : 'writeable',
          ...
          },
          {
            ...
            items : [
...

                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/webrtc/' ],
                ...
                },
                {
                  ...
                  value : {
                    ...
                    conditional : '!rtc.webrtc'
                  },
                  urls : [ [ 'w3c',
                      'http://ortc.org/wp-content/uploads/2014/10/ortc.html' ] ]
                },
                {
                  id : 'datachannel',
                  name : 'Data channel',
      ...
      items : [
          {
            ...
            items : [
...

                {
                  ...
                  name : 'Attributes',
                  urls : [ [ 'mdn', '/Web/Guide/HTML/Drag_and_drop' ] ],
                  items : [
                      {
                        id : 'draggable',
...

                {
                  ...
                  urls : [ [ 'mdn', '/Web/Guide/HTML/Content_Editable' ] ],
                  items : [
                      {
                        id : 'contentEditable',
            ...
            items : [
                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/WebCryptoAPI/' ] ]
                },
                {
                  id : 'csp10',
                  name : 'Content Security Policy 1',
                  value : 3,
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/CSP1/' ],
                ...
                },
                {
                  ...
                  status : 'proposal',
                  value : 2,
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/CSP2/' ],
                      [ 'mdn', '/Web/Security/CSP' ] ]
                },
                {
                  id : 'cors',
                  ...
                  value : 4,
                  urls : [ [ 'mdn', '/Web/HTTP/Access_control_CORS' ] ]
                },
                {
                  id : 'integrity',
                ...
                },
                {
                  ...
                  value : 2,
                  urls : [ [ 'w3c', 'http://dev.w3.org/html5/postmsg/' ],
                ...
                },
                {
                  ...
                  urls : [
                      [ 'w3c',
                          'http://www.w3.org/TR/html5/embedded-content-0.html#attr-iframe-srcdoc' ],
      ...
      items : [
          {
            ...
            items : [
                ...
                },
                {
                  ...
                  status : 'proposal',
                  value : 10,
                  urls : [ [ 'w3c', 'https://www.w3.org/TR/service-workers/' ],
                ...
                },
                {
                  ...
                  status : 'proposal',
                  value : 2,
                  urls : [ [ 'w3c', 'https://w3c.github.io/push-api/' ],
          ...
          },
          {
            ...
            items : [
...

                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/IndexedDB/' ],
                      [ 'wp', '/apis/indexeddb' ],
...

                {
                  ...
                  value : {
                    maximum : 5,
                    conditional : '!storage.indexedDB.basic'
                  },
          ...
          },
          {
            ...
            items : [
...

                {
                  ...
                  name : 'FileSystem API',
                  status : 'experimental',
                  urls : [ [ 'w3c', 'http://w3c.github.io/filesystem-api/' ], ]
                },
...

                {
                  ...
                  status : 'rejected',
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/file-system-api/' ],
                      [ 'wp', '/apis/filesystem' ] ]
                } ]
          } ]
    },
      ...
      items : [
          {
            ...
            items : [
                ...
                },
                {
                  ...
                  urls : [ [ 'w3c', 'http://www.w3.org/TR/url/' ] ]
                },
                {
                  id : 'encoding',
                  name : 'Encoding API',
                  value : 2,
                  urls : [ [ 'whatwg', 'https://encoding.spec.whatwg.org' ],
            ...
            items : [
                {
                  ...
                  urls : [
                      ...
                      [ 'wp', '/dom/History' ],
                      [ 'mdn',
                          '/Web/Guide/API/DOM/Manipulating_the_browser_history' ] ]
                },
                {
                  id : 'pagevisiblity',
